...
import { CreditCard, ShieldCheck, HelpCircle, Info, PhoneCall, Car, FileText, Zap, AlertTriangle, CarFront, Shield, Droplet, User, Truck, Mic, X, MapPin, AlertCircle, Search, ArrowRight, Clock, Navigation, Sparkles } from 'lucide-react-native';
